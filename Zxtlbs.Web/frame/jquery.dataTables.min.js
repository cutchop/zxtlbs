...
fnStateSave:function(e,i){this.oApi._fnCreateCookie(e.sCookiePrefix+e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"首页",sLast:"尾页",sNext:"下页",sPrevious:"上页"},sEmptyTable:"没有数据",
sInfo:"第 _START_ 到 _END_ 条数据，共 _TOTAL_ 条数据",sInfoEmpty:"第 0 到 0 条数据，共 0 条数据",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"每页显示 _MENU_ 条数据",sLoadingRecords:"正在加载...",sProcessing:"正在处理...",sSearch:"搜索:",sUrl:"",sZeroRecords:"没有搜索到符合条件的数据"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",
