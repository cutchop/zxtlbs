        ...
        <div id="headerTop" class="lock">
            <div id="headerMain">
                ...
                <ul class="nav">
                    ...
                    <li id="nav_setting"><div class="wrapIcon" onclick="ajaxloading('setting','setting/index.html','系统设置')"><em class="navIcon_setting">&nbsp;</em><span>系统设置</span></div></li>
                ...
                <div class="area">
                    <div class="loginBox">
                        ...
                        <div class="loginText"><%=((Zxtlbs.Model.AUser)Session["AUser"]).USERNAME%></div>
                    </div>
            ...
            <div class="popTip-mr">
                <div class="popTip-mc">
                    <div class="userbox">
                        ...
                        <h3 class="userbox-name"><%=((Zxtlbs.Model.AUser)Session["AUser"]).USERNAME%></h3>
                        <p class="userbox-info"><%=((Zxtlbs.Model.AUser)Session["AUser"]).ORGNAME%></p>
                        </div>
<table class="tableStyle tableStyleNoBorder cb" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td><%=((Zxtlbs.Model.AUser)Session["AUser"]).USERID%></td>
    </tr>
    <tr>
        <td class="tr"><strong>电话</strong></td>
        <td><%=((Zxtlbs.Model.AUser)Session["AUser"]).PHONE%></td>
    </tr>
    <tr>
        <td class="tr"><strong>手机</strong></td>
        <td><%=((Zxtlbs.Model.AUser)Session["AUser"]).MOBILE%></td>
    </tr>
    <tr>
        <td class="tr"><strong>公司邮箱</strong></td>
        <td><%=((Zxtlbs.Model.AUser)Session["AUser"]).EMAIL%></td>
    </tr>
</table>
    ...
    <div class="z-window-ml"><div class="z-window-mr"><div class="z-window-mc">
        ...
        <table class="z-window-form"> 
            <tr> 
              ...
              <td class="space"><span class="z-font-gray"><%=((Zxtlbs.Model.AUser)Session["AUser"]).USERID%></span></td> 
            </tr> 
            <tr> 
              <td class="label">姓名</td> 
              <td class="space"><span class="z-basic-input"> 
                <input id="f-u-username" type="text" class="z-basic-text" value="<%=((Zxtlbs.Model.AUser)Session["AUser"]).USERNAME%>" /> 
                </span></td> 
            </tr>
            <tr> 
              <td class="label">电话</td> 
              <td class="space"><span class="z-basic-input"> 
                <input id="f-u-phone" type="text" class="z-basic-text" value="<%=((Zxtlbs.Model.AUser)Session["AUser"]).PHONE%>" /> 
                </span></td> 
            </tr> 
            <tr> 
              <td class="label">手机</td> 
              <td class="space"><span class="z-basic-input"> 
                <input id="f-u-mobile" type="text" class="z-basic-text" value="<%=((Zxtlbs.Model.AUser)Session["AUser"]).MOBILE%>" /> 
                </span></td> 
            </tr> 
            <tr> 
              <td class="label">邮箱</td> 
              <td class="space"><span class="z-basic-input"> 
                <input id="f-u-email" type="text" class="z-basic-text" value="<%=((Zxtlbs.Model.AUser)Session["AUser"]).EMAIL%>" /> 
                </span></td> 
            </tr>
        </table> 
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        setTimeout(function () {
            $('.sysinfoIcon').animate({ top: 15 }, 200).animate({ top: 0 }, 200).animate({ top: 12 }, 300).animate({ top: 0 }, 300).animate({ top: 7 }, 400).animate({ top: 0 }, 400)
        }, 500);
    })
</script>
</body>
